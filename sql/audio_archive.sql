...
ALTER TABLE `collections` ADD FOREIGN KEY (`id`) REFERENCES `collection_map` (`collection_id`);

ALTER TABLE `songs` ADD FOREIGN KEY (`id`) REFERENCES `collection_map` (`song_id`);
...
ALTER TABLE `songs` ADD FOREIGN KEY (`id`) REFERENCES `tag_map` (`song_id`);

ALTER TABLE `tags` ADD FOREIGN KEY (`id`) REFERENCES `tag_map` (`tag_id`);
